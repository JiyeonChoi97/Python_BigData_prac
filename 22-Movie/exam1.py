...
url = 'http://www.kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=430156241533f1d058c603178cc3ca0e&targetDt={date}'
...
pyplot.savefig('날짜별 관람객 빈도.png')
pyplot.show()

final_df.T.plot(rot=45)
pyplot.title('일주일간의 영화별 관람객 수 변화')
pyplot.savefig('일주일간의 영화별 관람객 수 변화.png')
pyplot.show()
